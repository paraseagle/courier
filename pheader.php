...
<div class="row bg-info">
	...
	<div class="row p-3" style="background-color:  #002b80;">
		<div class="col-2"></div>
		<div class="col-4 "><a href="pending.php" class="p-3 text-decoration-none text-light">Pending</a><a href="delivered.php" class="p-3 text-decoration-none text-light">Delivered</a><a href="addshipment.php" class="text-decoration-none text-light">Add Parcel</a></div>
		<div class="col-6"></div>
